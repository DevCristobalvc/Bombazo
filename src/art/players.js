...
export function heroSVG(team) {
  ...
  <svg viewBox="0 0 220 300" role="img" aria-label="Tu jugador con la camiseta de ${team.name}">
    ...
    <!-- pantaloneta -->
    <rect x="76" y="176" width="68" height="42" rx="10" fill="${shorts}"/>
    <!-- torso -->
    <path d="M74 102 L146 102 L140 184 L80 184 Z" fill="${shirt}"/>
    ...
    <!-- cabeza -->
    <circle cx="110" cy="70" r="30" fill="${skin}"/>
...
export function shooterSVG() {
  ...
  <g class="shooter-art">
    ...
    <rect x="-25" y="-82" width="50" height="32" rx="8" fill="var(--sh-shorts)"/>
    <path d="M-28 -148 L28 -148 L24 -76 L-24 -76 Z" fill="var(--sh-shirt)"/>
...
export function keeperSVG() {
  ...
  <g class="keeper-art">
    ...
    <path d="M-22 -112 L22 -112 L18 -62 L-18 -62 Z" fill="var(--gk-shirt)"/>
